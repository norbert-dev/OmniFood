...
<body>
    ...
    <!--Testamonials section starts here-->
    ...
    <!--Testamonials section ends here-->
    <!--Plans / fees section starts here-->
    ...
    <!--Footer ends here-->
    <!--Necessary minified JS scripts for the page-->
    ...
    <!--Google Analytics trackre script. Currently turned off. It is only for showcase at this moment-->
    <!--<script>
